...
# print(len(data))
# # datadir = 'Track'
# image_paths, steerings = load_img_steering("C:\\Users\\Dapplogix\\Documents\\self_driving\\behaviour_cloning\\IMG", data)
